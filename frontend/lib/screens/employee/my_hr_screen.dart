      ...
      children: [
        ...
        _buildPendenciaItem(
          ...
          onTap: () {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) => OccurrencesScreen(idFuncionario: widget.colaborador.id_funcionario!), settings: const RouteSettings(name: '/employee/occurrences')));
          }
        ),
